...
class WashingProgram2 extends WashingProgram {
	...
	protected void wash() throws InterruptedException {
		...
		// Head water to 40 degrees
		myTempController.putEvent(new TemperatureEvent(this,TemperatureEvent.TEMP_SET,40.0));
		mailbox.doFetch();
		
		// 	Pre-Wash for 15 minutes
		sleep((int) (15*60*1000/mySpeed));
		
		// Turn of heating to water
		...
		// **** Now standard clean as in wash1 just different degree
